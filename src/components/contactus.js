    ...
    return (
        <div>
            <div className="contact-hero">
                <img className="w-100 contacthero" src="./homepics/contact10.jpg" alt="" />
            </div>
            ...
            <div className="careupper">
                <div className="caresect mr-3">
                    ...
                    <p className="super-small">{t("part13")} 
                    <br/>
                    {t("part131")}</p>
                </div>
                <div className="caresect mr-3">
                    ...
                    <p className="super-small">info@frenchdentist.cn thefrenchdentalclinic@gmail.com</p>
                </div>
                <div className="caresect mr-3">
            ...
            <h2 className="title-header-center mt-5 ">
            {t("part113")}
            </h2>
