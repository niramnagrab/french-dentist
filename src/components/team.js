    ...
    <div>
      ...
      <div className="new-doctor">
        ...
        <div className="doctor-description">
          ...
          <p className="subheader-bold-left">Dental surgeon and implantologist</p>
          <ReadMore className="normal-p-text"
            text={[
      ...
      <div className="new-doctor">
        <div className="doctor-description">
          ...
          <p className="subheader-bold-left">Dental surgeon and cosmetic dentist</p>
          <ReadMore className="normal-p-text"
            text={[
      ...
      <div className="new-doctor">
        ...
        <div className="doctor-description">
          <h1>Dr Daan Chiou</h1>
          <p className="subheader-bold-left">Pediatric dentist and orthodontist</p>
          <ReadMore className="normal-p-text"
            text={[
